...
// (bulkCreateCandidates removed — the CSV import UI was removed by user
// request; legacy data migration happens by editing the candidates sheet
// directly. Single-row createCandidate stays as the primary entry point.)
